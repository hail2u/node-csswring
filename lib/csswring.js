...
var _wringDecl = function (decl) {
  ...
  if (prop === 'font-family') {
    decl.value = _cleanFamilies(value);
...
var _wringAtRule = function (atRule) {
  ...
  if (atRule.name === 'font-face') {
    atRule.each(function (decl, index) {
      var prop = decl.prop;
      var value = decl.value;
  ...
  if (atRule.name === 'namespace') {
    params = params.replace(_reUrl, '$1');
    params = list.space(params).map(function (param, index, p) {
...
CSSWring.prototype.postcss = function (css) {
  ...
  if (
    (css.last.type === 'atrule') &&
    (css.last.name === 'import' || css.last.name === 'namespace')
  ) {
